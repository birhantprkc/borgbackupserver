...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <!-- Low-storage alerts: server-wide threshold, per-user mute. -->
        <div class="card border-0 shadow-sm mt-4">
            ...
            <div class="card-body">
                <form method="POST" action="/profile">
                    ...
                    <?php $salOn = ($user['storage_alert_mode'] ?? 'percent') !== 'disabled'; ?>
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" role="switch"
                               id="salEnabled" name="storage_alert_enabled" value="1" <?= $salOn ? 'checked' : '' ?>>
                        <label class="form-check-label" for="salEnabled">Notify me when a storage location is low on space</label>
                    </div>
                    <div class="form-text mb-3">
                        How full is too full is set once for the server, under
                        <a href="/settings?tab=general">Settings &rarr; General</a>, so the alert
                        and the health endpoint always agree. This switch only decides whether you hear about it.
                    </div>
